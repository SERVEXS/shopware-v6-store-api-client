...
class InlineObject12 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['finish_url'] = $data['finish_url'] ?? null;
     ...
     * Sets finish_url
     *
     * @param string|null $finish_url URL to which the client should be redirected after successful payment
     *
     * @return self
     */
     ...
     * Sets error_url
     *
     * @param string|null $error_url URL to which the client should be redirected after erroneous payment
     *
     * @return self
     */
