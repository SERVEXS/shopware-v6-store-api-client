 ...
 */
class ProductListingCriteria implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductListingCriteria';
    ...
    public function setLimit($limit)
    {
        ...
        if (!is_null($limit) && ($limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling ProductListingCriteria., must be bigger than or equal to 0.');
        }
    ...
    public function setMinPrice($min_price)
    {
        ...
        if (!is_null($min_price) && ($min_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $min_price when calling ProductListingCriteria., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxPrice($max_price)
    {
        ...
        if (!is_null($max_price) && ($max_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_price when calling ProductListingCriteria., must be bigger than or equal to 0.');
        }
