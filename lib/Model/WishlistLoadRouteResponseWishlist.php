 ...
 */
class WishlistLoadRouteResponseWishlist implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WishlistLoadRouteResponse_wishlist';
