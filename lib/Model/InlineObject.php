...
class InlineObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $customer_comment Adds a comment from the customer to the order.
     *
     * @return self
     */
     ...
     * Sets affiliate_code
     *
     * @param string|null $affiliate_code The affiliate code can be used to track which referrer the customer came through. An example could be `Price-comparison-company-XY`.
     *
     * @return self
     */
     ...
     * Sets campaign_code
     *
     * @param string|null $campaign_code The campaign code is used to track which action the customer came from. An example could be `Summer-Deals`
     *
     * @return self
     */
