...
namespace ServeXS\Shopware\v6\Store;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://localhost/store-api';
    ...
    {
        $report  = 'PHP SDK (ServeXS\Shopware\v6\Store) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 6.4.9999999.9999999-dev' . PHP_EOL;
